    ...
    height: '100%'
      ...
      height: `${scaledWidth + scaledThickness + 60}px`
        ...
        transition: 'transform 0.3s ease, box-shadow 0.3s ease'
          ...
          {adjustedBorders.top && <div className="board-border board-border-top absolute top-0 left-0 right-0 h-2 bg-white bg-opacity-50 border border-opacity-50 border-white z-10" style={{
          transform: 'translateY(-1px)'
        }}></div>}
          {adjustedBorders.right && <div className="board-border board-border-right absolute top-0 bottom-0 right-0 w-2 bg-white bg-opacity-50 border border-opacity-50 border-white z-10" style={{
          transform: 'translateX(1px)'
        }}></div>}
          {adjustedBorders.bottom && <div className="board-border board-border-bottom absolute bottom-0 left-0 right-0 h-2 bg-white bg-opacity-50 border border-opacity-50 border-white z-10" style={{
          transform: 'translateY(1px)'
        }}></div>}
          {adjustedBorders.left && <div className="board-border board-border-left absolute top-0 bottom-0 left-0 w-2 bg-white bg-opacity-50 border border-opacity-50 border-white z-10" style={{
          transform: 'translateX(-1px)'
        }}></div>}
